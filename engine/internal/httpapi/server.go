...
func (s *Server) mux() *http.ServeMux {
	...
	mux.HandleFunc("GET /static/passkey-unknown.js", s.handleUnknownCredentialJS)
	...
	mux.HandleFunc("GET /rac.js", s.handleRACJS)
	mux.HandleFunc("GET /static/guacamole-common.js", s.handleGuacamoleJS)
